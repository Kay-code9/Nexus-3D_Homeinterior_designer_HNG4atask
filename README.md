...
## Who it's for
- Homeowners planning a remodel or redecorate
- Renters testing furniture and layouts before moving
- Young couples furnishing a new apartment
- Interior decorators wanting a quick client mockup
...
### 1.  Download the App
Will be available as an APK file.  
...
### 4. Start Designing
Add **walls, floors, furniture, and decor** using the intuitive toolbar.  
Customize **colors, textures, and layouts** to fit your unique style.
